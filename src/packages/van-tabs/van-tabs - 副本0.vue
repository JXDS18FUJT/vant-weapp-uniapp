  ...
  <view :class="tabsClass">
    <van-sticky :disabled="!sticky" :z-index="zIndex" :offset-top="offsetTop" :container="container"
      ...
      <view :class="tabsWrapClass">
        ...
        <scroll-view :scroll-x="scrollable" :scroll-left="scrollLeft" :class="tabsScrollClass"
      ...
      methods: {
        ...
        setLine(skipTransition) {
          ...
          this.$nextTick(() => {
            ...
            // #endif
            // #ifndef MP-ALIPAY
            doGetRect = () => this.getRect('.van-tab', true, this)
            // #endif
        ...
        scrollIntoView() {
          ...
          this.$nextTick(() => {
            ...
            // #ifndef MP-ALIPAY
            doGetRect = () => Promise.all([
              this.getRect('.van-tab', true, this),
              this.getRect('.van-tabs__nav', false, this)
