<template>
  <block v-if="inited">
    <view v-if="moveHandle" class="van-transition custom-class" :class="mainClass" :style="mainStyle"
      @transitionend="onTransitionEnd" @click="onClick" @touchmove.stop.prevent="noop">
      <slot />
    </view>
    <view v-else class="van-transition custom-class" :class="mainClass" :style="mainStyle"
      @transitionend="onTransitionEnd" @click="onClick">
      <slot />
    </view>
  </block>
</template>
