<template>
  ...
  <van-picker ref="datetimePicker" class="van-datetime-picker" :active-class="activeClass" :toolbar-class="toolbarClass"
    :column-class="columnClass" :title="title" :columns="columns" :item-height="itemHeight" :show-toolbar="showToolbar"
    :visible-item-count="visibleItemCount" :confirm-button-text="confirmButtonText"
    :cancel-button-text="cancelButtonText" @change="onChange" @confirm="onConfirm" @cancel="onCancel" />
</template>
...
<script>
  ...
  export default VantComponent({
    ...
    mounted() {
      this.datetimePicker = this.$refs['datetimePicker'];
    ...
    methods: {
      ...
      updateColumnValue(value) {
        ...
        const formatter = this.formatter || defaultFormatter;
        let picker = this.datetimePicker;
        ...
        return new Promise((resolve) => {
          ...
          if (picker) {
            ...
            setTimeout(() => {
              ...
              picker && picker.setValues(values);
            }, 300)
