...
<van-calendar :show="show" @close="()=>{ show=false }" @confirm="onConfirm" />
```
...
<van-calendar :show="show" @close="()=>{ show=false }" type="multiple" @confirm="onConfirm" />
```
...
<van-calendar :show="show" @close="()=>{ show=false }" type="range" @confirm="onConfirm" />
```
...
```html
<van-calendar :show="show" @close="()=>{ show=false }" :show-confirm="false" />
```
...
```html
<van-calendar :show="show" @close="()=>{ show=false }" color="#1989fa" />
```
...
```html
<van-calendar :show="show" @close="()=>{ show=false }" :min-date="minDate" :max-date="maxDate" />
```
...
```html
<van-calendar :show="show" @close="()=>{ show=false }" type="range" :formatter="formatter" />
```
...
```html
<van-calendar :show="show" @close="()=>{ show=false }" :round="false" position="right" />
```
