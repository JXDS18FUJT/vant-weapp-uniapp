<template>
  ...
  <!-- #endif -->
    ...
    <div>
    <!-- #endif -->
      <van-overlay v-if="overlay" :show="show" :z-index="zIndex" :custom-style="overlayStyle" :duration="duration"
        @click-overlay="onClickOverlay" />
      <view  v-if="inited" :class="popupBodyClass" :style="popupBodyStyle"
        @transitionend="onTransitionEnd">
        <slot />
        <van-icon v-if="closeable" :name="closeIcon" :class="currentCloseIconClass"
          :custom-class="currentCloseIconClass" @click="onClickCloseIcon" />
      </view>
    <!-- #ifdef H5 || APP-PLUS -->
    </div>
    <!-- #endif -->
